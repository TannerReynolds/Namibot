...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("bam")
    .setDescription(
      "Bam a user from the server using either a mention or an id"
    )
    ...
    .addStringOption((option) =>
      option
        .setName("reason")
        .setDescription("The reason for bamming this user")
        .setRequired(true)
    )
    .addStringOption((option) =>
      option
        .setName("duration")
        .setDescription("The amount of time to bam this user for")
    ),
