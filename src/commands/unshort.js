...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (
      ...
      interaction.channel.id !== guilds[interaction.guild.id].commandChannel
    )
      return sendReply(
        interaction,
        "error",
        `${emojis.error}  You have to go to the <#${guilds[interaction.guild.id].commandChannel}> channel to use this command`,
      );
