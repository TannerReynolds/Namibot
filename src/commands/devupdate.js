...
module.exports = {
  ...
  async execute(interaction) {
    ...
    function checkForUpdates() {
      ...
      const repoUrl =
        "https://raw.githubusercontent.com/TannerReynolds/Discord-Moderation-Bot/master/package.json";
      fs.writeFileSync(
        "../restart.js",
        `module.exports = { channel: "${interaction.channel.id}" }`,
      );
    ...
    function updateApplication(latestVersion) {
      exec("git pull", (error, stdout, stderr) => {
        ...
        sendReply(
          interaction,
          "main",
          `Application updated to version \`${latestVersion}\`. Exiting...`,
        );
        process.exit();
      });
    }
