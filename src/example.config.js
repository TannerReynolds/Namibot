...
const config = {
  ...
  guilds: {
    '438650836512669699': { // This line is your guild's ID
      ...
      logs: { // Enable specific types of logs for your server
        messageDelete: true,
        messageUpdate: true,
      ...
      features: { // Enable and configure bot features for your server
        checkAccountAge: {
        ...
        antiAds: { // Stops people from sending advertisements to other Discord servers when enabled and automatically warns them
        ...
        levels: { // Levelling system for the bot
          enabled: false,
          ...
          levelRoles: { // Object of your levels. the key should be a string of the level,
      ...
      commands: { // Full list of commands allowing you to enable them or disable them.
        sendembed: true,
        dangerroles: true,
        unshort: true,
        purge: true,
    ...
    '1061175459112550490': { // Extra servers can be added just by copying the object above and filling out the information
      name: 'Learn Japanese',
